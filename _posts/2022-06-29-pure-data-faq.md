---
title: Pure Data FAQ
excerpt: "Frequently Asked Questions about Pure Data."
toc: true
toc_sticky: true
tags:
- pure data
...
1.  [What version of Pure Data should I download?](#what-version-of-pure-data-should-i-download)
2.  [How can I change the color scheme?](#how-can-i-change-the-color-scheme)
3.  [What tutorials or books are recommended for beginners?](#what-tutorials-or-books-do-you-recommend-for-beginners)
4.  [How do I download external libraries?](#how-do-i-download-and-install-external-libraries)
...
-   [Pd Next](https://github.com/sebshader/pdnext/releases) - Color themed Pd. This is my personal recommendation since it is Pd vanilla but with color customization.
...
-   [Purr Data](https://puredata.info/downloads/purr-data) - Extended’s successor. It comes pre-installed libraries, improved appearance and experience, hence it is great for beginners. Note: It has some incompatibilities/differences with vanilla and can be glitchy at times.
-   [Plug Data](https://github.com/timothyschoen/PlugData/releases) -  Pd as a plug-in or standalone app. Enhanced GUI, autocompletion and comes with two pre-installed libraries (cyclone and else).
